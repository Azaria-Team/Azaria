...
import azaria.tools.Processor;
import azaria.tools.Tools;
...
import static azaria.tools.Tools.*;
...
public class UnitProcessor implements Processor {
    ...
    public void process(ExecutorService exec){
        content.units().each(Azaria::isAzaria, (UnitType type) -> submit(exec, type.name, () -> {

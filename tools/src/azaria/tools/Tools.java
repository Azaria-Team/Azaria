...
public final class Tools{
    ...
    public static void main(String[] args){
        ...
        Reflect.<ObjectMap<Class<?>, ModMeta>>get(Mods.class, mods, "metas").put(Azaria.class, meta);
    ...
    public static boolean load(Content content){
        synchronized(loaded){
            ...
            if(should){
                content.load();
                if (content instanceof MappableContent c) AZContentRegionRegistry.load(c);
            }

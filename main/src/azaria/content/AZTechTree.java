...
import static azaria.content.AZLiquids.*;
import static azaria.content.blocks.AZCoreRelatedBlocks.*;
import static azaria.content.blocks.AZPower.*;
import static azaria.content.blocks.AZWalls.*;
import static azaria.content.blocks.AZDrills.*;
import static azaria.content.AZSectorPreset.*;
import static mindustry.content.TechTree.*;
import static azaria.content.AZItems.*;
import static azaria.content.blocks.AZDistribution.*;
import static azaria.content.blocks.AZProduction.*;
import static azaria.content.blocks.AZTurrets.*;
import static azaria.content.blocks.AZLiquidBlocks.*;
import static azaria.content.blocks.AZUnitRelatedBlocks.*;
import static azaria.content.AZUnits.*;

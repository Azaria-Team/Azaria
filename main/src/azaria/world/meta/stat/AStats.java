...
public class AStats extends Stats{
    @Nullable
    private OrderedMap<azaria.world.meta.stat.AStatCat, OrderedMap<azaria.world.meta.stat.AStat, Seq<StatValue>>> aMap;
    ...
    public void add(azaria.world.meta.stat.AStat stat, float value, StatUnit unit) {
        this.add(stat, (AStatValues.number(value, unit)));
    }

    public void add(azaria.world.meta.stat.AStat stat, float value) {
        this.add(stat, value, StatUnit.none);
    }

    public void addPercent(azaria.world.meta.stat.AStat stat, float value) {
        this.add(stat, (AStatValues.number((float)((int)(value * 100.0F)), StatUnit.percent)));
    }

    public void add(azaria.world.meta.stat.AStat stat, boolean value) {
        this.add(stat, (AStatValues.bool(value)));
    }

    public void add(azaria.world.meta.stat.AStat stat, Item item) {
        this.add(stat, (AStatValues.items(new ItemStack(item, 1))));
    }

    public void add(azaria.world.meta.stat.AStat stat, ItemStack item) {
        this.add(stat, (AStatValues.items(item)));
    }

    public void add(azaria.world.meta.stat.AStat stat, Liquid liquid, float amount, boolean perSecond) {
        this.add(stat, (AStatValues.liquid(liquid, amount, perSecond)));
    }

    public void add(azaria.world.meta.stat.AStat stat, Attribute attr) {
        this.add(stat, attr, false, 1.0F, false);
    }

    public void add(azaria.world.meta.stat.AStat stat, Attribute attr, float scale) {
        this.add(stat, attr, false, scale, false);
    }

    public void add(azaria.world.meta.stat.AStat stat, Attribute attr, boolean floating) {
        this.add(stat, attr, floating, 1.0F, false);
    }

    public void add(azaria.world.meta.stat.AStat stat, Attribute attr, boolean floating, float scale, boolean startZero) {
    ...
    public void add(Stat stat, Attribute attr, boolean floating, float scale, boolean startZero) {
        add(azaria.world.meta.stat.AStat.get(stat),attr,floating,scale,startZero);
    ...
    public void add(azaria.world.meta.stat.AStat stat, String format, Object... args) {
        this.add(stat, (AStatValues.string(format, args)));
    }

    public void add(Stat stat, StatValue value) {
        add(azaria.world.meta.stat.AStat.get(stat),value);
    }
    public void add(azaria.world.meta.stat.AStat stat, StatValue value) {
        if (stat.toStat()!=null){
...
//        super.remove(stat);
        remove(azaria.world.meta.stat.AStat.get(stat));
    }
    public void remove(azaria.world.meta.stat.AStat stat) {
        if (stat.toStat()!=null){
        ...
        azaria.world.meta.stat.AStatCat category = stat.category;
    ...
    public final OrderedMap<azaria.world.meta.stat.AStatCat, OrderedMap<azaria.world.meta.stat.AStat, Seq<StatValue>>> toAMap(){
        if(aMap == null) aMap = new OrderedMap<>();

        //sort stats by index if they've been modified
        if(dirty){
            aMap.orderedKeys().sort();
            for(ObjectMap.Entry<azaria.world.meta.stat.AStatCat, OrderedMap<azaria.world.meta.stat.AStat, Seq<StatValue>>> entry : aMap.entries()){
    ...
    public void display(Table table){
        for(AStatCat cat : toAMap().keys()){
            OrderedMap<azaria.world.meta.stat.AStat, Seq<StatValue>> map = toAMap().get(cat);

...
public class TankUnit extends Unit implements Tankc, Shieldc, Teamc, Entityc, Physicsc, Posc, Itemsc, Weaponsc, ElevationMovec, Hitboxc, Syncc, Unitc, Drawc, Statusc, Healthc, Velc, Builderc, Rotc, Minerc {
    ...
    private transient float lastSlowdown = 1.0F;
    ...
    @Override
    public int classId() {
        return AZEntityMapping.classId(azaria.gen.TankUnit.class);
    }
    ...
    @Override
    public void lastDeepFloor(Floor arg0) {
        this.lastDeepFloor = lastDeepFloor;
    }

    @Override
    public void treadTime(float arg0) {
        this.treadTime = treadTime;
    }

    @Override
    public void walked(boolean arg0) {
        this.walked = walked;
    }

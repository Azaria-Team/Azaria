...
public class WaterMoveUnit extends Unit implements Shieldc, Teamc, Entityc, Physicsc, Posc, Itemsc, Weaponsc, Hitboxc, Syncc, Unitc, Statusc, WaterMovec, Healthc, Velc, Builderc, Rotc, Drawc, Minerc {
    ...
    public static WaterMoveUnit create() {
        return new WaterMoveUnit();
    }

    @Override
    public int classId() {
        return AZEntityMapping.classId(azaria.gen.WaterMoveUnit.class);
    }

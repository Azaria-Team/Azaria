...
public class DroneUnit extends Unit implements Builderc, Hitboxc, Entityc, Syncc, Dronec, Drawc, Posc, Teamc, Physicsc, Rotc, Unitc, Healthc, Statusc, Velc, Itemsc, Weaponsc, Shieldc, Minerc {
    ...
    public static DroneUnit create() {
        return new DroneUnit();
    }

    @Override
    public int classId() {
        return AZEntityMapping.classId(azaria.gen.DroneUnit.class);
    }
    ...
    @Override
    public void rotors(Rotor.RotorMount[] rotors) {
        this.rotors = rotors;
    }

    @Override
    public float rotSpeedScl() {
        return rotSpeedScl;
    }

    @Override
    public void rotSpeedScl(float rotSpeedScl) {
        this.rotSpeedScl = rotSpeedScl;
    }
